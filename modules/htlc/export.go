...
type Client interface {
	...
	CreateHTLC(request CreateHTLCRequest, baseTx sdk.BaseTx) (ctypes.ResultTx, error)
	ClaimHTLC(hashLock string, secret string, baseTx sdk.BaseTx) (ctypes.ResultTx, error)
