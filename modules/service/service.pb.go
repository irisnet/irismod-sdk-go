...
type ServiceBinding struct {
	...
	Deposit      github_com_irisnet_irishub_sdk_go_types.Coins `protobuf:"bytes,3,rep,name=deposit,proto3,castrepeated=github.com/irisnet/core-sdk-go/types.Coins" json:"deposit"`
...
type Request struct {
	...
	ServiceFee                 github_com_irisnet_irishub_sdk_go_types.Coins `protobuf:"bytes,6,rep,name=service_fee,json=serviceFee,proto3,castrepeated=github.com/irisnet/core-sdk-go/types.Coins" json:"service_fee" yaml:"service_fee"`
...
type CompactRequest struct {
	...
	Provider                   string                                        `protobuf:"bytes,3,opt,name=provider,proto3" json:"provider,omitempty"`
	ServiceFee                 github_com_irisnet_irishub_sdk_go_types.Coins `protobuf:"bytes,4,rep,name=service_fee,json=serviceFee,proto3,castrepeated=github.com/irisnet/core-sdk-go/types.Coins" json:"service_fee" yaml:"service_fee"`
...
type Pricing struct {
	Price              github_com_irisnet_irishub_sdk_go_types.Coins `protobuf:"bytes,6,rep,name=price,proto3,castrepeated=github.com/irisnet/core-sdk-go/types.Coins" json:"price"`
...
type PromotionByTime struct {
	...
	Discount  github_com_irisnet_irishub_sdk_go_types.Dec `protobuf:"bytes,3,opt,name=discount,proto3,customtype=github.com/irisnet/core-sdk-go/types.Dec" json:"discount"`
}
...
type PromotionByVolume struct {
	...
	Discount github_com_irisnet_irishub_sdk_go_types.Dec `protobuf:"bytes,2,opt,name=discount,proto3,customtype=github.com/irisnet/core-sdk-go/types.Dec" json:"discount"`
}
...
type Params struct {
	...
	MinDeposit           github_com_irisnet_irishub_sdk_go_types.Coins `protobuf:"bytes,3,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/irisnet/core-sdk-go/types.Coins" json:"min_deposit"`
	ServiceFeeTax        github_com_irisnet_irishub_sdk_go_types.Dec   `protobuf:"bytes,4,opt,name=service_fee_tax,json=serviceFeeTax,proto3,customtype=github.com/irisnet/core-sdk-go/types.Dec" json:"service_fee_tax" yaml:"service_fee_tax"`
	SlashFraction        github_com_irisnet_irishub_sdk_go_types.Dec   `protobuf:"bytes,5,opt,name=slash_fraction,json=slashFraction,proto3,customtype=github.com/irisnet/core-sdk-go/types.Dec" json:"slash_fraction" yaml:"slash_fraction"`
