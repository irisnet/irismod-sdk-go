...
var _ govtypesv1beta1.Content = &CommunityPoolCreateFarmProposal{}

func init() {
	govtypesv1beta1.RegisterProposalType(ProposalTypeCreateFarmPool)
}
...
func (cfp *CommunityPoolCreateFarmProposal) ValidateBasic() error {
	...
	if err := govtypesv1beta1.ValidateAbstract(cfp); err != nil {
		return err
	}
