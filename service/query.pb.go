...
type QueryEarnedFeesResponse struct {
	Fees github_com_irisnet_core_sdk_go_types.Coins `protobuf:"bytes,1,rep,name=fees,proto3,castrepeated=github.com/irisnet/irishub-sdk-go/types.Coins" json:"fees" yaml:"service_fee"`
}
